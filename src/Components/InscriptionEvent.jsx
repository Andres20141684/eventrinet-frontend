...
class InscriptionEvent extends Component{
    constructor(props){
        super(props);
        this.state = {
            msg: "Not Connected",
      ...
      handleClicInscripcionEvento = () => {
        try{ //Verify if I'm logged
            ...
            if (retrievedJson == null){ //I'm not logged
                ...
                sessionStorage.setItem('currentPage', "InscriptionEvent");			    
			    window.location.replace("./login");
                return
            }
            //I'm logged
            console.log('redireccionando a ... inscribirse evento');
            this.handleNextChildComponentChange(Portafolio);
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="row" id="gradient">
                ...
                <div class="col-md-8" id="overview">
                    ...
                    <br/><br/>
                    <div class="row">
                        <button type="button" class="btn btn-success form-control text-center" onClick={this.handleClicInscripcionEvento}>Inscribete</button>
                    </div>    
                </div>
            </div>
            <div class="row">
