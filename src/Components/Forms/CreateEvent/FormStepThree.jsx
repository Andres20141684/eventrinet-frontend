            ...
            <div clas="panel-group" style={styles.panel}>
                ...
                <div class="form-group col-md-6">
                    ...
                    <DatePicker
                      ...
                      minDate={this.props.fechaAnt===null?new Date():new Date(this.props.fechaAnt).setDate(this.props.fechaAnt.getDate()+2)}
                ...
                <div class="form-group col-md-5">
                    ...
                    <DatePicker
                      ...
                      minDate={this.props.value.faseIni===''?new Date():new Date(this.props.value.faseIni).setDate(this.props.value.faseIni.getDate()+2)}
